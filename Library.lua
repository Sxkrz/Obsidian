...
local BaseURL = "https://raw.githubusercontent.com/Sxkrz/Obsidian/refs/heads/main/"
...
function Library:CreateWindow(WindowInfo)
    ...
    if true then
        local ToggleButton = Library:AddDraggableButton("<b><font color='#FFEA00'>Azure</font></b>", function()
            Library:Toggle()
        end, true, true)
