...
do
    ...
    function ThemeManager:CreateThemeManager(groupbox)
        ...
        local Load = groupbox:AddButton("Load", function()
        ...
        local Del = groupbox:AddButton("Delete", function()
            local name = self.Library.Options.ThemeManager_CustomThemeList.Value
        ...
        groupbox:AddDivider()
        local Set = groupbox:AddButton("Set Default", function()
            if
        ...
        Set:AddButton("Reset Default", function()
