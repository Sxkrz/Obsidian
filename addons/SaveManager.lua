...
local SaveManager = {} do
    ...
    SaveManager.Parser = {
        ...
        Dropdown = {
            Save = function(idx, object)
                return { type = "Dropdown", idx = idx, value = object.Value, mutli = object.Multi, mode = object.Mode }
            end,
            Load = function(idx, data)
                local object = SaveManager.Library.Options[idx]
                if object then
                    if data.mode and object.SetMode then object:SetMode(data.mode) end
                    object:SetValue(data.value)
                end
            end,
        },
    ...
    function SaveManager:BuildConfigSection(tab)
        ...
        load = section:AddButton("Load", function()
        ...
        load:AddButton("Overwrite", function()
            local name = self.Library.Options.SaveManager_ConfigList.Value
        ...
        DEL = section:AddButton("Delete", function()
            local name = self.Library.Options.SaveManager_ConfigList.Value
        ...
        DEL:AddButton("Refresh", function()
            self.Library.Options.SaveManager_ConfigList:SetValues(self:RefreshConfigList())
            self.Library.Options.SaveManager_ConfigList:SetValue(nil)
        end)
        section:AddDivider()
        self.AutoloadLabel = section:AddLabel("Current Autoload: " .. self:GetAutoloadConfig(), true)
        SET = section:AddButton("Set Autoload", function()
            local name = self.Library.Options.SaveManager_ConfigList.Value
        ...
        SET:AddButton("Reset Autoload", function()
