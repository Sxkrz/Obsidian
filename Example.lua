local repo = "https://raw.githubusercontent.com/Sxkrz/Obsidian/refs/heads/main/"
...
local Tabs = {
	...
	SpecialTab = Window:AddTab("Special Tab", "sparkle"),
...
local GroupBox = Tabs.SpecialTab:AddLeftGroupbox("Groupbox", "apple")
